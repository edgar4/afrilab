...
<section class="get-touch-area">
    <div class="container">
        <div class="sec-title text-center">
            ...
            <p>We recently helped a small business grow from break-even to over $1m profit in less than 2 years. Please
                find below contact details and contact us today!</p>
        </div>
        <div class="row">
            <!--Start single item-->
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="single-item hvr-grow-shadow text-center">
                    ...
                    <div class="text-holder">
                        ...
                        <span class="border"></span>
                        <p>Monday to Saturday: 09.00am to 18.00pm<br> Sunday: <a href="contact.html#">Closed</a></p>
                    </div>
                </div>
            </div>
            <!--End single item-->
